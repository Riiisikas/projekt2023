      ...
      if (client.available()) {
        ...
        if (c == '\n') {
          if (currentLine.length() == 0) {
            ...
            client.println("Hour: <input type='text' name='hour' pattern='[0-9]*' title='Only numbers allowed' /><br>");
            client.println("Minute: <input type='text' name='minute' pattern='[0-9]*' title='Only numbers allowed' /><br><br>");
